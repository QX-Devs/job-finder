...
export const translations = {
  en: {
    ...
    confirmDeleteResume: "Are you sure you want to delete this resume? This action cannot be undone.",
    cancel: "Cancel",
    confirm: "Confirm",
    loading: "Loading...",
    ...
    keywordSearchPlaceholder: "Search by keyword...",
    ...
    noJobsMatchFilters: "No jobs found — try adjusting your filters.",
...
verificationHelpMessage: "Need help? You can request a new verification email from your dashboard.",
    ...
    githubUsernameHint: "Enter only your username (e.g., johndoe)",
    linkedinProfile: "LinkedIn Profile",
    linkedinUsernamePlaceholder: "username",
    linkedinUsernameHint: "Enter only your username (e.g., johndoe)",
    ...
    remove: "Remove",
    iAmFreshGraduate: "I am a fresh graduate / I have no prior work experience",
    workExperienceOptionalForGraduates: "Work experience is optional for fresh graduates.",
    workExperienceOptionalMessage: "You can proceed without work experience. This field is optional for fresh graduates.",
    workExperienceRequiredMessage: "Please add at least one work experience entry if available.",
    atLeastOneExperienceRequired: "Please add at least one work experience entry.",
    graduateProceedMessage: "As a fresh graduate, you may proceed without filling work experience. Focus on Education and Skills in the following steps.",
    courseSuggestionMessage: "Adding relevant courses increases your hiring score. Courses are weighted 35% for fresh graduates in our ATS ranking system.",
    maybeLater: "Maybe Later",
    addCourses: "Add Courses",
    graduationProject: "Graduation Project / Final Year Project",
    graduateProjectPrompt: "Since you don't have work experience, please add your graduation project and highlight the key skills you gained.",
    graduateProjectPromptDesc: "Your graduation project demonstrates your technical abilities and problem-solving skills. This will help employers understand your capabilities.",
    projectTitle: "Project Title",
    projectTitlePlaceholder: "e.g., E-Commerce Platform with AI Recommendations",
    ...
    roleInProjectRequired: "Your role in the project is required",
    projectDuration: "Project Duration",
    projectDurationPlaceholder: "e.g., 6 months, 1 semester",
    ...
    projectSkillsMinimumMet: "Great! You've selected enough skills.",
    moreSkillsNeeded: "more skills needed (minimum 5)",
    projectSkillsMinimumRequired: "Please select at least 5 skills gained from this project",
    courses: "Courses",
    course: "Course",
    coursesDescription: "Add relevant courses and certifications to enhance your profile",
    courseName: "Course Name",
    courseNamePlaceholder: "e.g., Introduction to Machine Learning",
    provider: "Provider/Institution",
    providerPlaceholder: "e.g., Coursera, Udemy, University Name",
    completionDate: "Completion Date",
    category: "Category",
    categoryPlaceholder: "e.g., Data Science, Web Development",
    certificateUrl: "Certificate URL (Optional)",
    certificateUrlPlaceholder: "https://...",
    addCourse: "Add Course",
    coursesTipForGraduates: "Adding relevant courses increases your hiring score by 35% for fresh graduates!",
...
//cv generator v1
  ...
  ar: {
    ...
    delete: "حذف",
    deleting: "جاري الحذف...",
    deleteFailed: "فشل حذف السيرة الذاتية",
    confirmDeleteResume: "هل أنت متأكد أنك تريد حذف هذه السيرة الذاتية؟ لا يمكن التراجع عن هذا الإجراء.",
    cancel: "إلغاء",
    confirm: "تأكيد",
    ...
    keywordSearchPlaceholder: "ابحث بالكلمات المفتاحية...",
    ...
    noJobsMatchFilters: "لم يتم العثور على وظائف — حاول تعديل الفلاتر.",
...
verificationHelpMessage: "هل تحتاج مساعدة؟ يمكنك طلب بريد تحقق جديد من لوحة التحكم.",
    ...
    githubUsernamePlaceholder: "اسم المستخدم",
    githubUsernameHint: "أدخل اسم المستخدم فقط (مثال: johndoe)",
    linkedinProfile: "حساب LinkedIn",
    linkedinUsernamePlaceholder: "اسم المستخدم",
    linkedinUsernameHint: "أدخل اسم المستخدم فقط (مثال: johndoe)",
    ...
    remove: "إزالة",
    iAmFreshGraduate: "أنا خريج جديد / ليس لدي خبرة عمل سابقة",
    workExperienceOptionalForGraduates: "الخبرة العملية اختيارية للخريجين الجدد.",
    workExperienceOptionalMessage: "يمكنك المتابعة دون خبرة عمل. هذا الحقل اختياري للخريجين الجدد.",
    workExperienceRequiredMessage: "يرجى إضافة مدخل خبرة عمل واحد على الأقل إن أمكن.",
    atLeastOneExperienceRequired: "يرجى إضافة مدخل خبرة عمل واحد على الأقل.",
    graduateProceedMessage: "كخريج جديد، يمكنك المتابعة دون ملء خبرة العمل. ركز على التعليم والمهارات في الخطوات التالية.",
    courseSuggestionMessage: "إضافة دورات ذات صلة يزيد من نقاط التوظيف. الدورات موزونة بنسبة 35% للخريجين الجدد في نظام تصنيف ATS.",
    maybeLater: "ربما لاحقاً",
    addCourses: "إضافة دورات",
    graduationProject: "مشروع التخرج / مشروع السنة النهائية",
    graduateProjectPrompt: "بما أنك لا تملك خبرة عمل، يرجى إضافة مشروع التخرج وتسليط الضوء على المهارات الرئيسية التي اكتسبتها.",
    graduateProjectPromptDesc: "مشروع التخرج يوضح قدراتك التقنية ومهاراتك في حل المشكلات. سيساعد هذا أصحاب العمل على فهم قدراتك.",
    projectTitle: "عنوان المشروع",
    projectTitlePlaceholder: "مثال: منصة تجارة إلكترونية مع توصيات بالذكاء الاصطناعي",
    projectDescription: "وصف المشروع",
    projectDescriptionPlaceholder: "اوصف مشروعك بالتفصيل (200 حرف على الأقل). أدرج المشكلة التي حلها، نهجك، والنتائج المحققة.",
    projectDescriptionRequired: "وصف المشروع مطلوب",
    projectDescriptionMinLength: "يجب أن يكون وصف المشروع 200 حرف على الأقل",
    projectTitleRequired: "عنوان المشروع مطلوب",
    roleInProject: "دورك في المشروع",
    roleInProjectPlaceholder: "مثال: مطور Full-stack، قائد الفريق، مصمم قاعدة البيانات",
    roleInProjectRequired: "دورك في المشروع مطلوب",
    projectDuration: "مدة المشروع",
    projectDurationPlaceholder: "مثال: 6 أشهر، فصل دراسي واحد",
    technologiesUsed: "التقنيات المستخدمة",
    technologiesPlaceholder: "اكتب للبحث عن التقنيات (مثال: React، Node.js، MongoDB...)",
    technologiesRequired: "تقنية واحدة على الأقل مطلوبة",
    githubRepository: "رابط GitHub / المستودع",
    supervisor: "المشرف / الأستاذ",
    supervisorPlaceholder: "مثال: د. أحمد محمد",
    projectSkillsQuestion: "ما هي المهارات التي اكتسبتها من هذا المشروع؟",
    projectSkillsHint: "اختر 5-7 مهارات على الأقل قمت بتطويرها أو استخدمتها خلال هذا المشروع:",
    projectSkillsMinimumMet: "رائع! لقد اخترت مهارات كافية.",
    moreSkillsNeeded: "مهارات إضافية مطلوبة (5 على الأقل)",
    projectSkillsMinimumRequired: "يرجى اختيار 5 مهارات على الأقل اكتسبتها من هذا المشروع",
    courses: "الدورات",
    course: "دورة",
    coursesDescription: "أضف دورات وشهادات ذات صلة لتعزيز ملفك الشخصي",
    courseName: "اسم الدورة",
    courseNamePlaceholder: "مثال: مقدمة في تعلم الآلة",
    provider: "المزود/المؤسسة",
    providerPlaceholder: "مثال: Coursera، Udemy، اسم الجامعة",
    completionDate: "تاريخ الإتمام",
    category: "الفئة",
    categoryPlaceholder: "مثال: علوم البيانات، تطوير الويب",
    certificateUrl: "رابط الشهادة (اختياري)",
    certificateUrlPlaceholder: "https://...",
    addCourse: "إضافة دورة",
    coursesTipForGraduates: "إضافة دورات ذات صلة يزيد من نقاط التوظيف بنسبة 35% للخريجين الجدد!",
